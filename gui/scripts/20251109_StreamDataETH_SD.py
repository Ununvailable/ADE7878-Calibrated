...
def main():
    ...
    pal.setColor(QtGui.QPalette.ColorRole.Text, QtGui.QColor("#dddddd"))
    pal.setColor(QtGui.QPalette.ColorRole.Button, QtGui.QColor("#2d2d30"))
    pal.setColor(QtGui.QPalette.ColorRole.ButtonText, QtGui.QColor("#dddddd"))
